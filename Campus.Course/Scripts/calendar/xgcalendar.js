...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function BuildDaysAndWeekView(startday, l, events, config) {
            ...
            //html.push("<table style=\"height: 1008px\" id=\"tgTable\" class=\"tg-timedevents\" cellspacing=\"0\" cellpadding=\"0\"><tbody>");//parkerz
            html.push("<table style=\"height: 504px\" id=\"tgTable\" class=\"tg-timedevents\" cellspacing=\"0\" cellpadding=\"0\"><tbody>");
        ...
        function BuildWT(ht, dayarrs, events, dMax) {
            ...
            for (var i = 0; i < dayarrs.length; i++) {
                ...
                {
                    //ht.push("<th abbr='", dateFormat.call(dayarrs[i].date, i18n.xgcalendar.dateformat.fulldayvalue), "' class='gcweekname gcweek-today' scope=\"col\"><div title='", title, "' ", ev, " class='wk-dayname'><span class='", cl, "'>", dayarrs[i].display, "</span></div></th>");//parkerz
                    ht.push("<th abbr='", dateFormat.call(dayarrs[i].date, i18n.xgcalendar.dateformat.fulldayvalue), "' class='gcweek-today' scope=\"col\"><div ", ev, " class='wk-dayname'><span>", dayarrs[i].display, "</span></div></th>");
                }
                else
                {
                    //ht.push("<th abbr='", dateFormat.call(dayarrs[i].date, i18n.xgcalendar.dateformat.fulldayvalue), "' class='gcweekname' scope=\"col\"><div title='", title, "' ", ev, " class='wk-dayname'><span class='", cl, "'>", dayarrs[i].display, "</span></div></th>");//parkerz
        ...
        function BuildDayScollEventContainer(ht, dayarrs, events) {
            ...
            //ht.push("<div id=\"tgnowptr\" class=\"tg-nowptr\" style=\"left:0px;top:", mHg, "px\"></div>");//parkerz
            var tmt = "";
            //for (var i = 0; i < 24; i++) { parkerz
            for (var i = 8; i < 20; i++) {
            ...
            for (var i = 0; i < l; i++) {
                ...
                // Today
                if (istoday) {
                    //ht.push("<div style=\"margin-bottom: -1008px; height:1008px\" class=\"tg-today\">&nbsp;</div>");//parkerz
                    ht.push("<div style=\"margin-bottom: -504px; height:504px\" class=\"tg-today\">&nbsp;</div>");
                }
                //var eventC = $(eventWrap);
                //onclick=\"javascript:FunProxy('rowhandler',event,this);\"
                //ht.push("<div  style=\"margin-bottom: -1008px; height: 1008px\" id='tgCol", i, "' class=\"tg-col-eventwrapper\">");//parkerz
                ht.push("<div  style=\"margin-bottom: -504px; height: 504px\" id='tgCol", i, "' class=\"tg-col-eventwrapper\">");
...
//                }//parkerz
        ...
        function gP(h, m) {
            //return h * 42 + parseInt(m / 60 * 42); parkerz
            return (h-8) * 42 + parseInt(m / 60 * 42);
        }
        function gW(ts1, ts2) {
            var t1 = ts1 / 42;
            var t2 = parseInt(t1);
